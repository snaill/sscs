...
{
    DrawRect( screen, m_rc, SDL_MapRGB(screen->format, 192, 192, 192) );
    ...
    rect.w = m_rc.w - 2;
    rect.h = m_rc.h - 2;
    DrawRect( screen, rect, SDL_MapRGB(screen->format, 0, 0, 0) );

    rect.x = rect.x + 1;
    rect.y = rect.y + 1;
    rect.w = rect.w - 2;
    rect.h = rect.h - 2;
    DrawRect( screen, rect, SDL_MapRGB(screen->format, 192, 192, 192) );
}
